...
4. **⚙️ Performance & DX rapides**
   ...
   - [x] 2026-05-27: retrait Vercel obsolète et préparation du déploiement automatique GitHub Actions → VPS après CI verte, avec rollback minimal et documentation ops.
