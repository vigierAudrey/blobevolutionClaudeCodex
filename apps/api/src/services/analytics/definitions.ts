...
export const ANALYTICS_DEFINITIONS = {
  riderActiveDay: 'Match decision, message sent, blobosphere view or outbound click (consented). Note: booking request signal removed (feature deprecated).',
  proActiveDay: 'Message sent, profile/slot update, or pro dashboard open (consented). Note: booking response signal removed (feature deprecated).',
  ...
  ttfvRider: 'Time between signup and first value action (message sent or match accept). Note: booking request signal removed (feature deprecated).',
  ttfvPro: 'Time between pro verification and first message sent. Note: booking request signal removed (feature deprecated).',
