...
export const ANALYTICS_DEFINITIONS = {
  riderActiveDay: 'Search pros/nearby, booking request, match decision, message sent, blobosphere view or outbound click (consented).',
  proActiveDay: 'Booking response, message sent, profile/slot update, or pro dashboard open (consented).',
  ...
  ttfvRider: 'Time between signup and first value action (booking request, message sent, or match accept).',
  ttfvPro: 'Time between pro verification and first request received or first message sent.',
  supplyDemand: 'Booking requests versus pro availabilities by sport and large zone.',
