...
**Scope**: Express API security architecture (authentication, authorization, CSRF, CORS, headers, monitoring)
...
- **CORS stricte** basée sur la liste blanche `ALLOWED_ORIGINS`.
...
- `CSRF_PROTECTION.md` (dans `apps/api/`) – détails CSRF/session
- `../../scripts/generate-secrets.sh` – génération rapide de secrets
- `../../ROADMAP.md` – section Sécurité Production-Ready
- Audits historiques (racine) : `SECURITY_AUDIT_*.md`, `SECURITY_FIXES_*.md`, `SECURITY_EXECUTIVE_SUMMARY_*.md`
