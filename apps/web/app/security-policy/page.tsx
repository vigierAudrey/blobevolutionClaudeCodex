...
export const metadata: Metadata = {
  title: 'Politique de Sécurité - Blobinfini',
  description: 'Politique de divulgation responsable des vulnérabilités et programme de bug bounty de Blobinfini',
};
        ...
        <div className="bg-white shadow-lg rounded-lg p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Chez <strong>Blobinfini</strong>, la sécurité de nos utilisateurs est notre priorité absolue.
          ...
          <section>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
              <p className="text-sm text-yellow-800">
                <strong>Note :</strong> Blobinfini est une startup éducative avec des moyens limités.
