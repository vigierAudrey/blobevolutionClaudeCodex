...
export default function SessionSafetyPage() {
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      <h1 className="text-2xl font-semibold">Sécurité des sessions</h1>
      ...
      <section className="mt-6 space-y-4">
        ...
        <p>
          ...
          Les cours et les sessions se préparent directement entre utilisateurs, sans réservation ni paiement intégrés.
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Pour un cours avec un pro, vérifie son identité, ses qualifications, son assurance et les conditions proposées.</li>
          <li>Garde les échanges importants dans la messagerie Blob afin de pouvoir les retrouver si besoin.</li>
