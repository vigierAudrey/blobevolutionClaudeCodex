...
## Objectif
Transformer un prompt brut en une version opérationnelle, contextualisée pour Blob et exploitable par une IA (Codex ou Claude Code).
...
4. Vérifier la cohérence avec les règles Blob :
